<template>
  <div class="personCenter">
    <el-card style="width: 600px;height: 600px" shadow="hover">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" style="float:left">
      ...
      <div style="float: right;margin-left: 0;padding: 0" >
        <el-button style="margin-top: 202px" @click="dialogFormVisible=true">修改密码</el-button>
      </div>
    </el-card>
